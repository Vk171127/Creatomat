...
export default function Quotes() {
    ...
    return (
      ...
      /></Card>
            ...
            <Typography color="#A267AC" variant="h3" gutterBottom sx={{ paddingLeft:"5%", paddingRight:"5%", paddingTop:"5%", justifyContent:"center", alignItems:"center", textAlign:"justify"}}>
                Heading!  Quos blanditiis tenetur
            </Typography>
            <Typography color="#A267AC" variant="body2" gutterBottom sx={{paddingLeft:"5%", paddingRight:"5%", paddingBottom:"5%", justifyContent:"center", alignItems:"center", textAlign:"justify"}}>
